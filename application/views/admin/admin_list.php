     ...
     <h2 style="margin-top:0px">Admin List</h2>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="220px">
				<?php 
				echo anchor(site_url('admin/read/'.$admin->id_admin),'<i class="fa fa-eye"></i>Read',array('tittle'=>'Read','class'=>'btn btn-primary btn-sm')); 
				echo '  '; 
				echo anchor(site_url('admin/update/'.$admin->id_admin),'<i class="fa fa-pencil-square-o"></i>Update',array('tittle'=>'Update','class'=>'btn btn-success btn-sm')); 
				echo '  '; 
				echo anchor(site_url('admin/delete/'.$admin->id_admin),'<i class="fa fa-trash-o"></i>Delete','tittle="Delete" class="btn btn-danger btn-sm", onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
